...
package object consumer {
  ...
  def callbackConsumerOn[R, E](queueName: String, topology: Declaration)(
    userFunction: String => ZIO[R, E, Unit]
  ): ZIO[R with Consumer, E, Unit] =
    ZIO.access[Consumer](_.consumer.callbackConsumerOn[R, E](queueName, topology)(userFunction)).flatten

  def pollingConsumerOn[R, E](queueName: String, topology: Declaration)(
    userFunction: String => ZIO[R, E, Unit]
  ): ZIO[R with Consumer, E, Unit] =
